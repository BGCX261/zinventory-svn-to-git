	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 240,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: 'images/progressbg_green.gif'
				height			: 20,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,									// Calls back with the config object that has the current percentage, target percentage, current image, etc
				boxImage		: '/application/media/js/jquery.progressbar/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:  '/application/media/js/jquery.progressbar/progressbg_red.png',
									30: '/application/media/js/jquery.progressbar/progressbg_orange.png',
									70: '/application/media/js/jquery.progressbar/progressbg_green.png'
							  },
